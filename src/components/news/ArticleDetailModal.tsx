            ...
            <div className={`${focusMode ? 'w-full' : 'lg:col-span-8'} space-y-6`}>
              ...
              <div className="pt-4 border-t border-slate-200 dark:border-slate-800 flex items-center justify-between font-ui">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-5 py-2.5 rounded-xl bg-sky-700 hover:bg-sky-800 text-white font-bold text-xs transition-colors flex items-center gap-2 shadow-md"
                >
                ...
                <div className="sticky top-20 space-y-6">
                  ...
                  <div className="p-5 rounded-2xl bg-sky-50/90 dark:bg-slate-900 border border-sky-200 dark:border-slate-800 space-y-4 shadow-sm">
                    ...
                    <button
                      ...
                      className="w-full py-2.5 px-4 rounded-xl bg-sky-700 hover:bg-sky-800 text-white font-bold text-xs transition-all flex items-center justify-center gap-2 shadow-sm cursor-pointer"
                    >
